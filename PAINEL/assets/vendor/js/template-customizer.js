!function () {
    ...
    var t = {
        7621: function (t, e, s) {
            var i = s(8081), a = s.n(i), o = s(3645), n = s.n(o), l = s(1667), r = s.n(l), c = new URL(s(6468), s.b),
                u = n()(a()), d = r()(c);
            ...
            t.exports = function (t) {
                ...
                return e.toString = function () {
                    ...
                    var n = {};
                    if (i) for (var l = 0; l < this.length; l++) {
                        var r = this[l][0];
                        null != r && (n[r] = !0)
                    }
            ...
            function s(t) {
                for (var s = -1, i = 0; i < e.length; i++) if (e[i].identifier === t) {
                    s = i;
                    break
                }
                return s
            ...
            function i(t, i) {
                for (var o = {}, n = [], l = 0; l < t.length; l++) {
                    var r = t[l], c = i.base ? r[0] + i.base : r[0], u = o[c] || 0, d = "".concat(c, " ").concat(u);
                    o[c] = u + 1;
    ...
    !function () {
        ...
        var t = s(3379), e = s.n(t), a = s(7795), o = s.n(a), n = s(569), l = s.n(n), r = s(3565), c = s.n(r),
            u = s(9216), d = s.n(u), h = s(4589), p = s.n(h), m = s(7621), y = {};
        ...
        var b = ["rtl", "style", "layoutType", "layoutMenuFlipped", "showDropdownOnHover", "layoutNavbarFixed", "layoutFooterFixed", "themes"],
            _ = ["light", "dark"], x = document.documentElement.classList,
            w = document.getElementsByTagName("HTML")[0].getAttribute("data-theme") || 0,
            S = x.contains("dark-style") ? "dark" : "light", z = "rtl" === document.documentElement.getAttribute("dir"),
            F = !!x.contains("layout-menu-collapsed"), k = !!x.contains("layout-menu-flipped"),
            C = !!x.contains("layout-navbar-fixed"), A = !!x.contains("layout-footer-fixed"),
            ...
            E = function () {
                function t(e) {
                    var s = e.cssPath, i = e.themesPath, a = e.cssFilenamePattern, o = e.displayCustomizer,
                        n = e.controls, l = e.defaultTextDir, r = e.defaultLayoutType, c = e.defaultMenuCollapsed,
                        u = e.defaultMenuFlipped, d = e.defaultShowDropdownOnHover, h = e.defaultNavbarFixed,
                        p = e.defaultFooterFixed, m = e.styles, y = e.defaultStyle, f = e.availableThemes,
                    ...
                    if (function (t, e) {
                        ...
                        if (this.settings = {}, this.settings.cssPath = s, this.settings.themesPath = i, this.settings.cssFilenamePattern = a || "%name%.css", this.settings.displayCustomizer = void 0 === o || o, this.settings.controls = n || b, this.settings.defaultTextDir = "rtl" === l || z, this.settings.defaultLayoutType = r || T, this.settings.defaultMenuCollapsed = void 0 !== c ? c : F, this.settings.defaultMenuFlipped = void 0 !== u ? u : k, this.settings.defaultShowDropdownOnHover = void 0 !== d ? d : void 0, this.settings.defaultNavbarFixed = void 0 !== h ? h : C, this.settings.defaultFooterFixed = void 0 !== p ? p : A, this.settings.availableThemes = f || t.THEMES, this.settings.defaultTheme = this._getDefaultTheme(void 0 !== g ? g : w), this.settings.styles = m || _, this.settings.defaultStyle = y || S, this.settings.lang = E || "en", this.pathResolver = v || function (t) {
                            ...
                            -1 !== N && (this.settings.controls = this.settings.controls.slice(0, N).concat(this.settings.controls.slice(N + 1)))
                        }
                ...
                return e = t, s = [{
                    ...
                    key: "_loadSettings", value: function () {
                        var t, e = this._getSetting("Rtl"), s = this._getSetting("Style"),
                            i = this._getSetting("LayoutCollapsed"), a = this._getSetting("LayoutMenuFlipped"),
                            o = this._getSetting("ShowDropdownOnHover"), n = this._getSetting("FixedNavbar"),
                    ...
                    key: "_setup", value: function () {
                        ...
                        var o = this.container.querySelector(".template-customizer-close-btn"), n = function () {
        ...
        E.THEMES = [{name: "theme-default", title: "Default"}, {
            ...
            title: "Semi Dark"
        }, {name: "theme-bordered", title: "Bordered"}], E.LANGUAGES = {
            en: {

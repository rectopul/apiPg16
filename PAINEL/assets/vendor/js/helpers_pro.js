    ...
    return function () {
                ...
                if (null != n) {
                    ...
                    try {
                        if (r = (n = n.call(t)).next, 0 === e) {
                            ...
                            u = !1
                        } else for (; !(u = (i = r.call(n)).done) && (a.push(i.value), a.length !== e); u = !0) ;
                    } catch (t) {
                        l = !0, o = t
                    } finally {
                        try {
        ...
        var h = {
            ...
            _unbindLayoutAnimationEndEvent: function () {
                ...
                this._transitionCallbackTimeout && (clearTimeout(this._transitionCallbackTimeout), this._transitionCallbackTimeout = null), e && this._transitionCallback && u.forEach((function (n) {
            ...
            setCollapsed: function () {
                var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : d("collapsed"),
            ...
            setAutoUpdate: function () {
                var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : d("enable");
            ...
            on: function () {
                var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : d("event"),
                    ...
                    o = t.split("."), r = i(o, 1), s = r[0], a = t.split("."), u = n(a), l = u.slice(1);
                l = l.join(".") || null, this._listeners.push({event: s, namespace: l, callback: e})
            },
            off: function () {
                var t = this, e = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : d("event"),
                    o = e.split("."), r = i(o, 1), s = r[0], a = e.split("."), u = n(a), l = u.slice(1);
